              ...
              '
                ...
                focus:border-emerald-200 '
                  ...
                  <button
                    ...
                    type='submit'
                    className='flex justify-center mx-auto disabled:cursor-not-allowed  font-medium rounded-lg text-sm px-5 py-2.5 text-center  focus:outline-nonehover:bg-gradient-to-br bg-gradient-to-r  focus:ring-4 focus:outline-none
                shadow-green-800/80 
                hover:text-black
                text-white 
                from-cyan-400 
